        ...
        <SidebarInset className="overflow-auto">
          ...
          <main className="flex-1 p-6">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">إدارة حسابات المستخدمين وأدوارهم</p>
            </div>
            
            <Card>
              <CardHeader>
                <CardTitle>قائمة المستخدمين</CardTitle>
                <CardDescription>جميع المستخدمين المسجلين في النظام مع أدوارهم</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-muted/50">
                        ...
                        <TableHead className="text-right w-[150px]">القسم</TableHead>
                    ...
                    <TableBody>
                      {filteredUsers.map((user) => (
                        <TableRow key={user.id} className="hover:bg-muted/50 transition-colors">
                          ...
                          <TableCell className="text-right text-muted-foreground">{user.department}</TableCell>
